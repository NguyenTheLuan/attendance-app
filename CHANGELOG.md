...
### 🐛 Bug Fixes
- fix: improve mobile responsiveness of EditModal layout and spacing
...
### ✨ Features
- feat: add terms of service page for privacy and usage policies
...
### 🐛 Bug Fixes
- fix(ci): ensure unique release tags by auto-incrementing existing ones
...
### 🔧 Maintenance
- ci: improve version bump logic in deploy workflow
...
- 🔧 chore: bump version to v0.0.29
- Merge pull request #4 from NguyenTheLuan/improve-bump-version
- 🔧 chore: bump version to v0.0.29
- 🔧 chore: bump version to v0.0.29
- 🔧 chore: bump version to v0.0.29
- 🔧 chore: bump version to v0.0.29
